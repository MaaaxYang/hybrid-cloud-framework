...
public class ActiveController {
    ...
    public void init(){
        ...
        list.add("["+System.currentTimeMillis() +"] - account : ssq@bodhi.cn");
        ...
        list.add("["+System.currentTimeMillis() +"] - bodhi application downloading ...");
        list.add("["+System.currentTimeMillis() +"] - bodhi application download success");
        list.add("["+System.currentTimeMillis() +"] - bodhi client downloading ...");
        list.add("["+System.currentTimeMillis() +"] - bodhi client download success");
        list.add("["+System.currentTimeMillis() +"] - all module download success");
        list.add("["+System.currentTimeMillis() +"] - refreshing .. ");
        list.add("["+System.currentTimeMillis() +"] - bodhi service started");
        list.add("load end");
    }

...
public class PlatformBootstrap {
    ...
    public static <T extends ApplicationContext> ApplicationContext run(BestsignConfig config, ThreadPoolConfig threadPoolConfig, Class<T> clazz){
        PlatformManager.init(config,threadPoolConfig);
        return PlatformManager.startApplication(clazz);
    }

    public static <T extends ApplicationContext> ApplicationContext run(BestsignConfig config, Class<T> clazz){
